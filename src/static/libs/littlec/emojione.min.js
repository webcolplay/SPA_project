(function(ns) {
	...
	ns.imagePathPNG = 'http://static.bizz.cmccim.com/download/Web_IM_emoji_png/';
			...
			if ((typeof shortname === 'undefined') || (shortname === '') || (!(shortname in ns.emojioneList))) {
				...
				if (ns.imageType === 'png') {
					if (ns.sprites) {
						...
						replaceWith = '<img class="emojione" src="' + ns.imagePathPNG + unicode + '.png' + ns.cacheBustParam + '"/>'
					}
				} else {
					if (ns.sprites) {
			...
			str = str.replace(ns.regAscii, function(entire, m1, m2, m3) {
				...
				if (ns.imageType === 'png') {
					if (ns.sprites) {
						...
						replaceWith = m2 + '<img class="emojione" src="' + ns.imagePathPNG + unicode + '.png' + ns.cacheBustParam + '"/>'
					}
				} else {
					if (ns.sprites) {
						replaceWith = '<svg class="emojione"><description>' + alt + '</description><use xlink:href="' + ns.imagePathSVGSprites + '#emoji-' + unicode + '"></use></svg>'
